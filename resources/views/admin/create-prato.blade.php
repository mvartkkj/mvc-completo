...
<head>
    ...
    <title>Cadastrar Prato | Sabor & Cia</title>
...
<body class="bg-background">
    ...
    <div class="main-content">
        <div class="top-bar">
            <div>
                <h1 class="text-xl font-semibold text-foreground">Cadastrar Prato</h1>
                <p class="text-sm text-muted-foreground">Adicione um novo prato ao cardápio</p>
            </div>
        ...
        <div class="content-card">
            <h2>Novo Prato</h2>
            <p>Preencha os campos abaixo para cadastrar um novo prato. Os campos marcados com * são obrigatórios.</p>
            ...
            <form method="POST" action="{{ route('admin.pratos.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select 
                            id="cod_cat" 
                            name="cod_cat" 
                            class="form-select @error('cod_cat') error @enderror"
                            required
                        >
                            <option value="">Selecione...</option>
                            @foreach($categorias as $categoria)
                                <option value="{{ $categoria->cod_cat }}" {{ old('cod_cat') == $categoria->cod_cat ? 'selected' : '' }}>
                                    {{ $categoria->descricao }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <!-- Foto -->
                    <div class="form-group full-width">
                        <label class="form-label" for="foto_prato">Foto do Prato</label>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-primary">Cadastrar Prato</button>
                </div>
            </form>
        </div>
    </div>
