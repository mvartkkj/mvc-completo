...
<head>
    ...
    <title>Editar Mesa | Sabor & Cia</title>
...
<body>
    <div class="container">
        <div class="card">
            <div class="header">
                <h1>✏️ Editar Mesa</h1>
                <p>Atualize as informações da mesa #{{ $mesa->cod_mesa }}</p>
            </div>
            ...
            <form action="{{ route('admin.mesas.update', $mesa->cod_mesa) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        id="descricao" 
                        name="descricao" 
                        value="{{ old('descricao', $mesa->descricao) }}" 
